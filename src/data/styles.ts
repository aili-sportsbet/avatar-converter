...
export const styles: StylePreset[] = [
  ...
  },
  {
    ...
    palette: ["#efe4d8", "#b95e4b", "#2f2a28", "#f8f1e9"],
    ratio: "3:4",
    realism: 8,
    polish: 8,
    creativity: 6,
  ...
  },
  {
    ...
    palette: ["#ffffff", "#f3b7c8", "#4b3642", "#ffe7ee"],
    ratio: "4:5",
    realism: 7,
    polish: 7,
    creativity: 7,
  ...
  },
  {
    ...
    palette: ["#eeeeeb", "#6f7275", "#151515", "#f5f2ed"],
    ratio: "4:5",
    realism: 9,
    polish: 8,
    creativity: 4,
  ...
  },
  {
    ...
    palette: ["#f8f7f2", "#dce5e2", "#485158", "#ffffff"],
    ratio: "4:5",
    realism: 8,
    polish: 7,
    creativity: 4,
  ...
  },
  {
    ...
    palette: ["#e9f7f5", "#0f766e", "#203534", "#ffffff"],
    ratio: "1:1",
    realism: 5,
    polish: 7,
    creativity: 7,
...
export const makeupStyles = [
  ...
  "no obvious makeup changes beyond natural refinement",
];

export const accessories = [
  "no visible accessories unless present in the reference",
  "elegant gold stud earrings if they suit the subject",
  "delicate silk scarf accent if it complements the outfit",
  "minimal accessories, never distracting from the face",
];

export const formats = [
  { value: "professional headshot", label: "Headshot" },
  { value: "profile avatar", label: "Avatar" },
  { value: "founder portrait", label: "Founder" },
];

export const defaultControls: ControlValues = {
  format: "professional headshot",
  identity: "confident startup founder",
